"""08 · Banner pixel art: rasteriza las comunas de la Región Metropolitana a grillas de celdas.
...
OUT = Path(sys.argv[2] if len(sys.argv) > 2 else Path(__file__).resolve().parents[2] / "assets" / "banner_grid.json")
PILOTO = {13101: "Santiago", 13112: "La Pintana", 13114: "Las Condes", 13201: "Puente Alto"}
...
out = dict(
    ...
    escritorio=grilla(-71.25, -70.20, -33.675, -33.335, 300),
    movil=grilla(-70.80, -70.40, -33.70, -33.36, 120),
)
