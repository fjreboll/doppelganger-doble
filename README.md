...
| `secviz.js` | Bandas generativas por sección (canvas de píxeles, sin dependencias): barrido del parque de viviendas, caída de la confianza junto al umbral, cien hogares, deriva de las dos lecturas, tres lecturas, fichas de seis campos y compuertas del método. Se detienen fuera de pantalla y respetan `prefers-reduced-motion` |
